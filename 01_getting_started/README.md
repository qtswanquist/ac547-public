...
7. Select “Save and Print” and save the generated PDF to your computer. From there you need to take a screen grab or a picture of the document and upload to GitHub for verification. 
8. GitHub should get back to you within a week with access to the education package (if you receive an instant email rejection try to follow the instructions on the rejection email to troubleshoot).
...
2. Download the latest version for your operating system (e.g., version 3.13.5).
...
9. You can allow JetBrains AI as part of your subscription. This will allow you to use JetBrains AI tools. This is optional... as of July 2025, they require payment information to activate (though you have free access).
